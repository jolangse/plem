...
public enum SensorType
{
	...
	BARO_24B	( 16, "Barometric pressure (generic)", "pressure", 800.0f, 1500.0f ),	// unsigned 24bit 4096 count
	HUMI_8B		( 32, "Relative humidity (generic)", "humidity", 0.0f, 100.0f ),	// 8 bit unsigned
	LUMI_8B		( 64, "Light level in percent (generic)", "light", 0.0f, 100f ),	// 8 bit unsigned
	LUMI_16B	( 65, "Illumination in lux (generic)", "light", 0.0f, 65000f ),		// 16 bit unsigned
	LUMI_24B	( 66, "Illumination in lux (generic)", "light", 0.0f, 65000f ),		// 24 bit x32 multiple
